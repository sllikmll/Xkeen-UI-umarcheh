...
def main() -> int:
    ...
    ap.add_argument('--tag', default='v0.2.0-desktop-previews')
    ns=ap.parse_args()
    expected=[
      'Unified-UI-Avalonia-Preview-0.2.0-win-x64.zip',
      'Unified-UI-WPF-Preview-0.2.0-win-x64.zip',
      'Unified-UI-Cpp-Win32-Preview-0.2.0-win-x64.zip',
    ]
    artifacts=[]; errors=[]
